...
router.use("/copy", require("./book_copy_db")); //requiring the book_copy_db controller
...
router.use("/transaction", require("./book_transaction_db")); //requiring the search_db controller
